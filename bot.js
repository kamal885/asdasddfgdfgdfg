...
client.on("message", message => {
 if (message.content === '2help') {
  const embed = new Discord.RichEmbed()
      .setColor("#000000")
      .setDescription(`
3play ⇏ لتشغيل أغنية برابط أو بأسم
3skip ⇏ لتجاوز الأغنية الحالية
3pause ⇏ ايقاف الأغنية مؤقتا
3resume ⇏ لمواصلة الإغنية بعد ايقافها مؤقتا
3vol ⇏ لتغيير درجة الصوت 100 - 0
3stop ⇏ لإخرآج البوت من الروم
3np ⇏ لمعرفة الأغنية المشغلة حاليا
3queue ⇏ لمعرفة قائمة التشغيل
 `)
